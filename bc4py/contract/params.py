allow_globals = ['__name__', '__doc__', '__package__', '__spec__', '__annotations__', 'SourceFileLoader']
...
allow_builtins = [
    ...
    'UnicodeWarning', 'UserWarning', 'ValueError', 'Warning', 'WindowsError', 'ZeroDivisionError', '__name__',
    '__package__', 'locals', 'globals', 'staticmethod', 'super', 'callable', 'classmethod', 'issubclass',
    '__build_class__', '__debug__', 'abs', 'all', 'any', 'ascii', 'bin', 'bool', 'bytearray', 'bytes', 'chr',
    'complex', 'delattr', 'dict', 'dir', 'divmod', 'enumerate', 'filter', 'float', 'format', 'frozenset',
    'getattr', 'hasattr', 'hash', 'hex', 'id', 'int', 'isinstance', 'iter', 'len', 'list', 'map', 'max',
    'min', 'next', 'object', 'oct', 'ord', 'pow', 'print', 'property', 'range', 'repr', 'reversed', 'round',
    'set', 'setattr', 'slice', 'sorted', 'str', 'sum', 'tuple', 'type', 'vars', 'zip'
]
