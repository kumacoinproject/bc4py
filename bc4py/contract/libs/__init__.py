...
from bc4py.contract.libs.test_method import *
...
from bc4py.contract.libs import convert, test_method, hashgenerator, nem_network, signature

__all__ = tuple()
__all__ += convert.__all__
__all__ += test_method.__all__
...
__price__.update(test_method.__price__)
